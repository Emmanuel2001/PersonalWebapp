...
namespace EbiMiMi.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<ApplicationUser> signInManager, ILogger<LoginModel> logger, EbiMiMi.Models.ApplicationDbContext context)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    auditrecord.AuditActionType = "Success Login";
                    auditrecord.DateTimeStamp = DateTime.Now;
                    auditrecord.KeyID = 777;
                    // 999 – dummy record 
